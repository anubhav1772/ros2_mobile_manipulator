...
def generate_launch_description():
    ...
    package_name_gazebo = 'ridgeback_ur5_gazebo'
    package_name_description = 'ridgeback_ur5_description'
    package_name_moveit = 'ridgeback_ur5_moveit_config'

    default_robot_name = 'ridgeback_ur5'
    gazebo_models_path = 'models'
    default_world_file = 'pick_place.world'
